...
first_normalized_target = y_train[0, 0].item()

first_original_target = scaler.inverse_transform(first_normalized_target)
...
for step in (3, 6, 9):
    ...
    normalized_value = test_sequences[0, sequence_index, 0, 0].item()

    original_value = scaler.inverse_transform(normalized_value)
