...
def calc_gso(dir_adj, gso_type):
    ...
    if (
        ...
        or gso_type == "rw_renorm_adj"
        or gso_type == "sym_renorm_lap"
        or gso_type == "rw_renorm_lap"
    ):
        adj = adj + id

    if (
        gso_type == "sym_norm_adj"
        or gso_type == "sym_renorm_adj"
        or gso_type == "sym_norm_lap"
        or gso_type == "sym_renorm_lap"
    ):
        ...
        gso_type == "rw_norm_adj"
        or gso_type == "rw_renorm_adj"
        or gso_type == "rw_norm_lap"
        or gso_type == "rw_renorm_lap"
    ):
