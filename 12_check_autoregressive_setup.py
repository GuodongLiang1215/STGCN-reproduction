...
raw_data = dataloader.load_velocity_data(
    DATASET
)

if raw_data.shape != (12672, 228):
    raise ValueError(
        f"数据形状错误：{raw_data.shape}"
    )
...
print(
    "\n5分钟后的真实速度:",
    raw_data[INDEX_5MIN, 0],
)

print(
    "15分钟后的真实速度:",
    raw_data[INDEX_15MIN, 0],
)

print(
    "30分钟后的真实速度:",
    raw_data[INDEX_30MIN, 0],
)

print(
    "45分钟后的真实速度:",
    raw_data[INDEX_45MIN, 0],
)
